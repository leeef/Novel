...
public class ReadSettingManager {
    ...
    public static final String SHARED_READ_FORMAT_TYPE = "shared_read_format_type";//段落间距样式
    ...
    public void setFormat(int format) {
        sharedPreUtils.putInt(SHARED_READ_FORMAT_TYPE, format);
    }

    // 默认段落间距=行间距等于字体大小的二倍
    public int getFormat() {
        return sharedPreUtils.getInt(SHARED_READ_FORMAT_TYPE, 1);
    }
    ...
    public int getTextSize() {
        return sharedPreUtils.getInt(SHARED_READ_TEXT_SIZE, ScreenUtils.spToPx(15));
    }
