...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = PhilosopherApplication.getContext().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = PhilosopherApplication.getContext().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics() {
        DisplayMetrics metrics = PhilosopherApplication
                .getContext()
                .getResources()
                .getDisplayMetrics();
        return metrics;
